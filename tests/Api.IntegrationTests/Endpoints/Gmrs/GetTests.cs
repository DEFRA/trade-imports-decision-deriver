...
namespace Defra.TradeImportsDecisionDeriver.Api.IntegrationTests.Endpoints.Gmrs;
...
public class GetTests : EndpointTestBase, IClassFixture<WireMockContext>
{
    ...
    public async Task Get_WhenNotFound_ShouldNotBeFound()
    {
        ...
        var response = await client.GetAsync(TradeImportsDecisionDeriver.Testing.Endpoints.Gmrs.Get(GmrId));
