...
public class DocumentDecisionResultTests
{
    ...
    [InlineData("H224", DecisionInternalFurtherDetail.E74, DocumentDecisionReasons.SplitChed)]
    [InlineData("H224", DecisionInternalFurtherDetail.E75, DocumentDecisionReasons.UpdateCrToReferenceSplitChed)]
    [InlineData("H224", DecisionInternalFurtherDetail.E84, DocumentDecisionReasons.CreateNewIpaffsNotification)]
    [InlineData("H224", DecisionInternalFurtherDetail.E85, DocumentDecisionReasons.PhsiCheckRequired)]
    [InlineData("H224", DecisionInternalFurtherDetail.E86, DocumentDecisionReasons.HmiCheckRequired)]
    [InlineData("H224", DecisionInternalFurtherDetail.E87, DocumentDecisionReasons.GmsInspection)]
